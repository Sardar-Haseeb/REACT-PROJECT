...
import './Kids.css'; // Add your custom styles if needed
...
const Kids = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const kidsProducts = productsList.filter(product => product.category === 'Kid');
  ...
  if (loading) {
    return <div>Loading kids' products...</div>;
  }
